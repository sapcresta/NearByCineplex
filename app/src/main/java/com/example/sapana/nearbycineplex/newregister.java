...
import com.example.sapana.nearbycineplex.helper.InputValidation;
import com.example.sapana.nearbycineplex.model.User;
import com.example.sapana.nearbycineplex.sql.DatabaseHelper;

public class newregister extends AppCompatActivity implements View.OnClickListener {
    private final AppCompatActivity activity = newregister.this;
    ...
    private void postDataToSQLite(){
        ...
        if (!inputValidation.isInputEditTextFilled(textInputEditTextNumber, textInputLayoutNumber, "Enter Number")) {
            return;
        }
